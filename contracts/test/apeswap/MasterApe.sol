...
contract BananaSplitBar is ERC20('BananaSplitBar Token', 'BANANASPLIT'), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(block.timestamp <= expiry, "BANANA::delegateBySig: signature expired");
...
contract MasterApe is Ownable {
    ...
    function checkPoolDuplicate(IERC20Mintable _lpToken) public view {
