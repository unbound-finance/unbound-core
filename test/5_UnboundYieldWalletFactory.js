...
describe("UnboundYeildWalletFactory", function() {
    ...
    describe("#create", async () => {
        ...
        it("should create yield wallet contract without revert", async function() { 
            ...
            await yieldWalletFactory.create(ethDaiPair.address, signers[0].address, ethDaiVault.address);

        });

        it("should create new yield wallet for first time user locking LPT", async function() { 

            expect(await ethDaiVault.yeildWallet(signers[0].address)).to.be.equal(zeroAddress)
            ...
            expect(await ethDaiVault.yeildWallet(signers[0].address)).to.not.equal(zeroAddress)
